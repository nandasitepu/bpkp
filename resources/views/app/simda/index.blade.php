  ...
  <div class="row">
    <div class="col-md-9">
      <div class="panel panel-default">
        ...
        <h3 class="text-center"><span class="label label-success">Sistem Informasi Manajemen Daerah (SIMDA) </span></h3>
        <hr>
        <p>
        ...
        <ul>
          ...
          <li> Membantu Satgas SIMDA Perwakilan BPKP melakukan asistensi implementasi Program Aplikasi Komputer SIMDA pada pemerintah daerah.</li>
    ...
    <div class="col-md-3">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <strong class="text-center"><h4><label class="label label-info">Tujuan SIMDA</label></h4></strong>
          <hr>
          <ul class="text-justify">
            <li>Menyediakan Database mengenai kondisi di daerah yang terpadu baik dari aspek keuangan, aset daerah, kepegawaian/aparatur daerah maupun pelayanan publik.</li>
            <li>  Mempersiapkan aparat daerah untuk mencapai tingkat penguasaan dan pendayagunaan teknologi informasi yang lebih baik.
              Memperkuat basis pemerintah daerah dalam melaksanakan otonomi daerah.</li>
          </ul>
