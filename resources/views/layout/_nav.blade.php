          ...
          <div class="row">
            <div class="col-xs-12 navfon">
              ...
              <ul class="collapse nav navbar-nav nav-collapse hidden-xs" id="nav-collapse1">
                  ...
                  <li>
                    <a href="#"><i class="fa fa-money" aria-hidden="true"></i>&nbsp; APD</a>
                  </li>
                  <li>
                    <a href="#"><i class="fa fa-hotel" aria-hidden="true"></i>&nbsp; IPP</a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="#"><i class="fa fa-headphones" aria-hidden="true"></i>&nbsp; INV</a>
                  </li>
                  <li>
