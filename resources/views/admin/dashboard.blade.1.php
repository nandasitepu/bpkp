      ...
      <div class="col-md-3">
          ...
          <div class="panel panel-default collapse in" id="sidemenu">
            <ul class="nav" >
              ...
              <li>
                <router-link to="/admin/dashboard/app">
              ...
              <li>
                <router-link to="/admin/dashboard/posts">
                  <i class="fa fa-file-o fa-fw"></i> &nbsp; Posts
                </router-link>
              </li>
              <li>
                <router-link to="/admin/dashboard/pages">
                  <i class="fa fa-calendar fa-fw"></i> &nbsp; Pages
                </router-link>
              </li>
              <li>
                <router-link  to="/admin/dashboard/pegawai">
              ...
              <li>
                <router-link to="/admin/dashboard/pengumuman">
                  <i class="fa fa-check-square-o fa-fw"></i> &nbsp; Pengumuman
                </router-link>
              </li>
              <li>
                <router-link to="/admin/dashboard/perpustakaan">
