    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="row">
            <div class="col-md-4">  
                <input type="date" id="s_tgl_awal" name="s_tgl_awal" class="form-control input-sm">
            </div>
            <div class="col-md-4"> 
                <input type="date" id="s_tgl_akhir" name="s_tgl_akhir" class="form-control input-sm">
            </div>
            <div class="col-md-4">
              <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Filter</button>
            </div>
          </div>
          <hr>
