    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading">
           <div class="row" style="background:#1bc6bb;color:#fff">
            <div class="col-md-9">
        ...
        <div class="panel-body">
          <div class="row" >
            <div class="col-md-4">
              <form action="{{route('tugas.filter')}}" method="GET" class="form-inline">
                  <label for="penanggung_jawab_id" class="col-form-label">Nama Pegawai:</label><br>
                  <div class="input-group" style="width:100%">
                    <select class="form-control select2 input-sm" name="pegawai_id" >
          ...
          <div class="table-responsive"> 
             <table id="tugas" class="table table-responsive hidden-xs" style="width:100%">
