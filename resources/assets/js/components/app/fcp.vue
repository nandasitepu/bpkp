  ...
  <div class="row">
      <div class="col-md-8">
        ...
        <div class="text-justify">
          ...
          <span class="text-center">
            <img class="img-thumbnail" v-bind:src="'/img/app/fraud-triangle.png'"  alt="" height="50px" >
            <br>
          </span>
      ...
      <div class="col-md-4 well">
        ...
        <ul class="medium">
          ...
          <li>Kepedulian Karyawan</li>
          <li>Kepedulian Pelanggan Masyarakat</li>
          <li> Perlindungan Pelapor</li>
          <li>Sistem Pelaporan Fraud</li>
